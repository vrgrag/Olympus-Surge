 ...
 *
 * See `.cursor/rules/oracle_user_agent.md` for the canonical shape.
 */
object OracleUaForge {
    ...
    private fun build(): String {
        val chrome = OracleSecrets.chromeVersion().ifEmpty { "149.0.0.0" }
        val webkit = OracleSecrets.webkitVersion().ifEmpty { "537.36" }
