package com.olympussurge.game.oracle.config

import com.olympussurge.game.oracle.crypt.OracleSecrets
 ...
 * SDK keys resolve lazily through [OracleSecrets] so plaintext never
 * lands in the binary.
 *
...
object OracleFacade {
    ...
    // ─────────────────────────────────────────────────────────
    const val PACKAGE_ID: String = "com.olympussurge.olympussurgegame"
    const val MARKET_ID: String = "com.olympussurge.olympussurgegame"
    const val DISPLAY_NAME: String = "Olympus Surge"

    // ─────────────────────────────────────────────────────────
    // Resolved endpoints / credentials (decoded lazily)
    // ─────────────────────────────────────────────────────────
    val configEndpoint: String get() = OracleSecrets.configEndpoint()
    val attributionKey: String get() = OracleSecrets.attributionKey()
    val messagingProject: String get() = OracleSecrets.messagingProject()
     ...
     */
    const val CONNECT_GRACE_MS: Long = 3_500L
    ...
    const val SAFE_AREA_DELAY_MS: Long = 900L
}
