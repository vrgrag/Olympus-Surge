...
import com.olympussurge.game.oracle.ui.OracleInviteScreen
 ...
 */
class OracleInviteActivity : ComponentActivity() {
    ...
    private fun proceed() {
        startActivity(
            Intent(this, OracleGateActivity::class.java)
                .putExtra(OracleGateActivity.EXTRA_TARGET_URL, targetUrl)
    ...
    companion object {
        const val EXTRA_TARGET_URL = "oracle_invite_target"
    }
}
